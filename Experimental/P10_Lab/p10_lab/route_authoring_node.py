    ...
    def author(
        ...
        diagnostics={
            ...
            "preview_mesh_lod":{
                ...
                "source_face_count":int(preview_geometry.get("mesh_lod",{}).get("source_face_count",0)),
                "authority":"DISPLAY_ONLY_P9_PRIMARYMESH_LOD",
                "lod_policy":str(preview_geometry.get("mesh_lod",{}).get("lod_policy","UNKNOWN")),
                "depth_layer_policy":str(preview_geometry.get("mesh_lod",{}).get("depth_layer_policy","UNKNOWN")),
            },
            ...
            "interaction_contract":{
                ...
                "selected_camera_live_internal_width":960,
                "selected_camera_live_points_policy":"FORCE_POINTS_HIGH",
                "selected_camera_frustum":True,
                "selected_camera_authoritative_refresh_node":"ConceptGhostP10SelectedDroneCameraPreview",
                "selected_camera_authoritative_refresh_profile":"HQ_160K_POINTS_120K_MESH_1280PX_DEFAULT",
                "local_view_controls":["ZOOM","NUDGE_LEFT_RIGHT_UP_DOWN","YAW_MINUS_PLUS","PITCH_MINUS_PLUS","DELETE_SELECTED_POINT"],
                "pivot_controls_scope":"PERSPECTIVE_ONLY",
